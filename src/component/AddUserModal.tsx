...
const AddUserModal: React.FC<AddUserModalProps> = ({ show, onClose, onUserAdded }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`✅ User added successfully: ${res.data.name}`);
      onUserAdded();
      onClose();
        ...
        <Modal.Body>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              className="form-control"
            />
            <Form.Text muted>Enter a valid 10-digit number.</Form.Text>
          </Form.Group>
 
          <Form.Group className="mb-3">
            <Form.Label>Role</Form.Label>
            <Form.Select value={role} onChange={e => setRole(e.target.value)} className="form-control">
